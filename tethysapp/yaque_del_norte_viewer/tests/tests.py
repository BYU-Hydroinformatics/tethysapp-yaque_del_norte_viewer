...
# from ..app import YaqueDelNorteViewer
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.yaque_del_norte_viewer"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.yaque_del_norte_viewer.tests.tests"

        To run tests in the YaqueDelNorteViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.yaque_del_norte_viewer.tests.tests.YaqueDelNorteViewerTestCase"

        To run only the test_if_tethys_platform_is_great function in the YaqueDelNorteViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.yaque_del_norte_viewer.tests.tests.YaqueDelNorteViewerTestCase.test_if_tethys_platform_is_great"
...
class YaqueDelNorteViewerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(YaqueDelNorteViewer)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(YaqueDelNorteViewer)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/yaque-del-norte-viewer/')  # The final '/' is essential for all pages/controllers
